...
fun main() {
    ...
    println("É antigo? ${if (carro1.Antigo()) "Sim" else "Não"}")
    ...
    println("É antigo? ${if (carro2.Antigo()) "Sim" else "Não"}")
    ...
    println("É antigo? ${if (caminhao1.Antigo()) "Sim" else "Não"}")
    ...
    println("É antigo? ${if (caminhao2.Antigo()) "Sim" else "Não"}")
}
