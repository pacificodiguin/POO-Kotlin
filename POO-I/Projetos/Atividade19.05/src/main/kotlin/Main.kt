...
fun main() {
    ...
    while (true) {
        ...
        when (scanner.nextLine().trim()) {
            ...
            "2" -> {
                jogador?.imprimeDados() ?: println("Crie um jogador primeiro.")
            }

            "3" -> {
                jogador?.mostrarIdade() ?: println("Crie um jogador primeiro.")
            }

            "4" -> {
                jogador?.calculaAposentadoria() ?: println("Crie um jogador primeiro.")
            }
